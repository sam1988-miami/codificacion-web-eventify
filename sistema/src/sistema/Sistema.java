...
public class Sistema {
    ...
    public static void main(String[] args) {
        ...
        for (Administrador_plataforma adm : admin) {
            System.out.println("\n--- Registro ---");
            System.out.println("de que color quedo la pagina? : " + adm.getPersonalizar_pagina());
            System.out.println("el ingreso al dashboard fue?: " + adm.getIngreso_dashboard());
            System.out.println("el ingreso al sistema fue: " + adm.getIngreso_sistema());
            System.out.println("la Gestion del evento fue: " + adm.getGestion_evento());
            System.out.println("se Aprobo el evento?: " + adm.getAprobar_evento());
            System.out.println("el respectivo problema fue: " + adm.getResolucion_problemas());
        }
